...
class ForecastViewer extends _react.default.Component {
  ...
  initForecastReducer() {
    ...
    const predictionCurveIdx = forecast && forecast.predictions && Number.isInteger(forecast.predictions.curveIdx) ? forecast.predictions.curveIdx : null;
    const payload = predictionCurveIdx === null ? forecast : {
      ...forecast,
      curveIdx: predictionCurveIdx
    };
