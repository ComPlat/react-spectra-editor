...
// eslint-disable-line
{
  ...
  hideCmdAnaViewerSt: _cfg.default.hideCmdAnaViewer(state.layout) || props.editorOnly && !(_format.default.isNmrLayout(state.layout) || _format.default.isIrLayout(state.layout)),
