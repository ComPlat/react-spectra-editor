...
const Submit = _ref => {
  ...
  const allowPredictInEditorOnly = _format.default.is1HLayout(layoutSt) || _format.default.is13CLayout(layoutSt) || _format.default.isIrLayout(layoutSt);
  const shouldShowPredict = !editorOnly || allowPredictInEditorOnly;
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)("span", {
    className: classes.groupRightMost,
    children: [ascendSelect(classes, hideSwitch, isAscendSt, toggleIsAscendAct), intensitySelect(classes, hideSwitch || !isEmWaveSt, isIntensitySt, toggleIsIntensityAct), decimalSelect(classes, hideSwitch, decimalSt, updateDecimalAct), shouldShowPredict ? /*#__PURE__*/(0, _jsxRuntime.jsx)(_r06_predict_btn.default, {
      feature: feature,
      forecast: forecast
    }) : null, operationSelect(classes, operations, operationSt, onChangeSelect), /*#__PURE__*/(0, _jsxRuntime.jsx)(_r05_submit_btn.default, {
      feature: feature,
      isAscend: isAscendSt,
