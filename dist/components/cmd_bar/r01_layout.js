...
const shiftSelect = (classes, layoutSt, setShiftRefAct, shiftSt, curveSt) => {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(_material.FormControl, {
    ...
    children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_material.InputLabel, {
      ...
      label: "Solvent",
      onChange: onChange,
      MenuProps: _common.toolbarSelectMenuProps,
...
function solventKeyOf(feature) {
  ...
  const r = metadata && metadata.solventName || metadata && metadata.solvent || meta && meta.solventName || meta && meta.solvent || feature && feature.solventName || feature && feature.solvent || null;
  const a = metadata && metadata.solvent_label || metadata && metadata.solventLabel || null;
...
function pickBestRef(list, key) {
  ...
  if (cand.length > 1) {
    ...
    if (vals.length) {
      ...
      cand = cand.slice().sort((a, b) => Math.abs((a.value != null ? a.value : m) - m) - Math.abs((b.value != null ? b.value : m) - m));
    }
    if (cand.length > 1) {
