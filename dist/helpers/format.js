...
const rmRef = function rmRef(peaks, shift) {
...
const formatedMS = function formatedMS(peaks, maxY) {
...
const formatedEm = function formatedEm(peaks, maxY) {
  let decimal = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2;
  let isAscend = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
...
const formatedUvVis = function formatedUvVis(peaks, maxY) {
  let decimal = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2;
  let isAscend = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  let isIntensity = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  let boundary = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : {};
...
const formatedEmissions = function formatedEmissions(peaks, maxY) {
  let decimal = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2;
  let isAscend = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  let isIntensity = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  let boundary = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : {};
...
const formatedDLSIntensity = function formatedDLSIntensity(peaks, maxY) {
  let decimal = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 2;
  let isAscend = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  let isIntensity = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
  let boundary = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : {};
...
const formatedHplcUvVis = function formatedHplcUvVis(peaks) {
...
const formatedXRD = function formatedXRD(peaks) {
...
const rmShiftFromPeaks = function rmShiftFromPeaks(peaks, shift) {
  let atIndex = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
...
const peaksWrapper = function peaksWrapper(layout, shift) {
  let atIndex = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  let solvTxt = '';
  const {
    shifts
...
const formatPeaksByPrediction = function formatPeaksByPrediction(peaks, layout, isAscend, decimal) {
...
const strNumberFixedDecimal = function strNumberFixedDecimal(number) {
...
const strNumberFixedLength = function strNumberFixedLength(number) {
...
const inlineNotation = function inlineNotation(layout, data) {
