...
var hidePanelCompare = function hidePanelCompare(layoutSt) {
  return !(_format2.default.isIrLayout(layoutSt) || _format2.default.isUvVisLayout(layoutSt) || _format2.default.isHplcUvVisLayout(layoutSt) || _format2.default.isXRDLayout(layoutSt));
};
