...
const niOffset = function niOffset(shiftSt) {
...
const msOffset = () => 0;
const extractPeaksEdit = exports.extractPeaksEdit = function extractPeaksEdit(feature, editPeakSt, thresSt, shiftSt, layoutSt) {
...
const extractAutoPeaks = exports.extractAutoPeaks = function extractAutoPeaks(feature, thresSt, shiftSt, layoutSt) {
