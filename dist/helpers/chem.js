...
const GetCyclicVoltaShiftOffset = exports.GetCyclicVoltaShiftOffset = function GetCyclicVoltaShiftOffset() {
...
const Convert2Peak = exports.Convert2Peak = function Convert2Peak(feature, threshold, offset) {
...
const buildPeakFeature = function buildPeakFeature(jcamp, layout, peakUp, s, thresRef) {
...
const Convert2DValue = exports.Convert2DValue = function Convert2DValue(doubleTheta) {
